...
class ReplayBuffer:
    ...
    def store_tuples(self, state, goal, action, reward, new_state, done):
    ...
    def sample_buffer(self, batch_size):
        ...
        goal_batch = self.goal_buffer[batch]
        ...
        return state_batch, goal_batch, action_batch, reward_batch, new_state_batch, done_batch
